...
public class TaintThreeLevels extends BaseTaint<TaintThreeLevels>  {
	...
	private static final TaintThreeLevels TOP   = new TaintThreeLevels("TOP");  // Tainted element (i.e. might be tainted)
	private static final TaintThreeLevels TAINT = new TaintThreeLevels("TAINT");  // Tainted element (i.e. definitly tainted)
	private static final TaintThreeLevels CLEAN = new TaintThreeLevels("CLEAN"); // Clean element (i.e. definitly clean)
	private static final TaintThreeLevels BOTTOM = new TaintThreeLevels("BOTTOM"); // Bottom element (i.e. error state)
	...
	public TaintThreeLevels(String status) {
		this.status = status;
	}
