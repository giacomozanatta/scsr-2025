...
public class HybridDivisionByZeroChecker implements
        SemanticCheck<SimpleAbstractState<PointBasedHeap, ValueEnvironment<HybridIntervals>, TypeEnvironment<InferredTypes>>> {
    private HybridOverflowChecker.NumericalSize size;

    public HybridDivisionByZeroChecker(HybridOverflowChecker.NumericalSize size) {
        this.size = size;
    }
