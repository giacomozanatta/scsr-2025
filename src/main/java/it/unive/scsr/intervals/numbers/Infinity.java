...
public abstract sealed class Infinity implements SigNum permits MinusInfinity, PlusInfinity {
  ...
  public final IntervalNumber divide(IntervalNumber other, Computation orElse) {
    ...
    // In a division only non-zero numeric values can appear as denominators, otherwise NaN is
    // returned.
    return finalize(other, orElse);
  }
