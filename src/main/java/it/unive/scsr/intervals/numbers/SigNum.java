...
public sealed interface SigNum
    ...
    default boolean sameSign(SigNum other) {
        // A SignNum is zero when it is neither positive nor negative. This condition will never be valid for Infinity
        // instances.
        Predicate<SigNum> isZero =
                sigNum -> !(sigNum.isPositive() || sigNum.isNegative());
        ...
        // Once this point is reached, the only possible elements to consider are Infinity instances or non-zero numeric
        // values.
        return isPositive() ?
                other.isPositive() :
                other.isNegative();
