...
public class DivByZeroTest {
    ...
    @Test
    public void testDivByZero() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/testing_divbyzero/908677-benchmark-divbyzero.imp");

        // we build a new configuration for the analysis
        LiSAConfiguration conf = new DefaultConfiguration();

        // we specify where we want files to be generated
        conf.workdir = "outputs/divbyzero_test_output/908677";
