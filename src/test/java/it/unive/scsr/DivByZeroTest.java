...
import it.unive.scsr.checkers.DivisionByZeroFloat;
import it.unive.scsr.checkers.DivisionByZeroPentFloat;
import it.unive.scsr.checkers.DivisionByZeroPentagons;
...
public class DivByZeroTest {
	...
	private <V extends ValueDomain<V>> void runAnalysisPent(V valueEnv, NumericalSize size, String path) throws ParsingException{
		...
		// the OverflowChecker is executed after the numerical analysis and it checks if a abstract numerical value leads to an overflow/underflow
		conf.semanticChecks.add(new DivisionByZeroPentagons(size));
	...
	private <V extends ValueDomain<V>> void runAnalysisFloat(V valueEnv, NumericalSize size, String path) throws ParsingException{
		...
		// the OverflowChecker is executed after the numerical analysis and it checks if a abstract numerical value leads to an overflow/underflow
		conf.semanticChecks.add(new DivisionByZeroFloat(size));
	...
	private <V extends ValueDomain<V>> void runAnalysisPentFloat(V valueEnv, NumericalSize size, String path) throws ParsingException{
		...
		// the OverflowChecker is executed after the numerical analysis and it checks if a abstract numerical value leads to an overflow/underflow
		conf.semanticChecks.add(new DivisionByZeroPentFloat(size));
