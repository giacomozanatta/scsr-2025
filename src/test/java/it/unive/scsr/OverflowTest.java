...
public class OverflowTest {
	...
	@Test
	public void testOverflowPentagonsUINT8() throws ParsingException,
			AnalysisException {
		runAnalysis(new Pentagons(), NumericalSize.UINT8, "pentagons-uint8");
	}

	@Test
	public void testOverflowPentagonsINT16() throws ParsingException,
			AnalysisException {
		runAnalysis(new Pentagons(), NumericalSize.INT16, "pentagons-int16");
	}

	@Test
	public void testOverflowPentagonsFLOAT8() throws ParsingException,
			AnalysisException {
