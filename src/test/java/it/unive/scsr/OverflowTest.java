...
import it.unive.scsr.checkers.OverflowCheckerPentagons;
...
public class OverflowTest {
	...
	public void testOverflowPentagonsUINT8() throws ParsingException, AnalysisException {
		runAnalysisPent(new Pentagons(), NumericalSize.UINT8, "pentagons-uint8");
	}
	
	@Test
	public void testOverflowPentagonsINT16() throws ParsingException, AnalysisException {
		runAnalysisPent(new Pentagons(), NumericalSize.INT16, "pentagons-int16");
	}
	
	@Test
	public void testOverflowPentagonsFLOAT8() throws ParsingException, AnalysisException {
		runAnalysisPent(new Pentagons(), NumericalSize.FLOAT8, "pentagons-float8");
	}
	...
	private <V extends ValueDomain<V>> void runAnalysisPent(V valueEnv, NumericalSize size, String path) throws ParsingException{
		...
		// the OverflowChecker is executed after the numerical analysis and it checks if a abstract numerical value leads to an overflow/underflow
		conf.semanticChecks.add(new OverflowCheckerPentagons(size));
