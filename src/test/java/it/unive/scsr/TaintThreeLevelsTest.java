...
public class TaintThreeLevelsTest {
    ...
    String[] sources = new String[] {"source", "source1", "source2"};

    String[] sanitizers = new String[] {"sanitizer", "sanitizer1", "sanitizer2"};

    String[] sinks = new String[] {"sink", "sink1", "sinks"};


    @Test
    public void testTaintThreeLevels() throws ParsingException, AnalysisException {
        // we parse the program to get the CFG representation of the code in it
        Program program = IMPFrontend.processFile("inputs/testing_taint3lvs/908677-benchmark-taint-3lvs.imp");
        ...
        conf.workdir = "outputs/taint3lvs_test_output/908677";
